"""
Django settings for kolomna project.
...
SECRET_KEY = "django-insecure-3c-33b9jh8k3mh(&g=t=b6@y#zsb4rrk7sd%1td-&#cm(m19p6"
...
WSGI_APPLICATION = "kolomna.wsgi.application"

# Database
# https://docs.djangoproject.com/en/5.0/ref/settings/#databases

if getenv("USE_SQLLITE", None) == "True":
    DATABASES = {
        "default": {
...
CALL_CENTER_BITRIX_USER_ID = getenv("CALL_CENTER_BITRIX_USER_ID")
